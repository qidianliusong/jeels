...
import com.wcyc.upms.dao.SysMenuDao;
...
@com.alibaba.dubbo.config.annotation.Service(
        version = "1.0",
        interfaceClass = ISysMenuService.class
)
@Service
...
public class SysMenuService extends BaseService<SysMenuDao, SysMenu> implements ISysMenuService {
    ...
    public void disableMenu(Long id) {
        ...
        Optional.ofNullable(sysMenu).orElseThrow(() -> new WcycException(HttpCodeEnum.NOT_FOUND));
...
//    @Cacheable(cacheNames="wcyc:upms:menus", key="#userId")
    @Override
