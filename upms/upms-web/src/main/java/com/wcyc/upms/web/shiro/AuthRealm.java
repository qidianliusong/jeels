...
public class AuthRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SysUserWebService sysUserService = ApplicationContextRegister.getBean(SysUserWebService.class);
//        ISysUserService sysUserService = ApplicationContextRegister.getBean(ISysUserService.class);
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        SysRoleWebService sysRoleService = ApplicationContextRegister.getBean(SysRoleWebService.class);
