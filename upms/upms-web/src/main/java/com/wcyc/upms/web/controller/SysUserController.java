...
import com.wcyc.base.common.util.FileUtils;
import com.wcyc.base.common.util.PasswordUtils;
...
public class SysUserController extends BaseController {
    ...
    public ReturnDTO update(@Valid SysUser sysUser, @RequestParam(value = "ids", defaultValue = "") Long[] roleIds) {
        ...
        if (ObjectUtils.isEmpty(sysUserDb)) {
            throw new WcycException(HttpCodeEnum.NOT_FOUND);
        }
    ...
    public ReturnDTO selectUserSideMenu() {
        ...
        return ReturnDTOUtil.success(sysUserService.selectUserAllInfoById(WcycSysUser.id()));
    }
