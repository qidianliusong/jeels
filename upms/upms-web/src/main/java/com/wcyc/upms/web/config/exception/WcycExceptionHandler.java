package com.wcyc.upms.web.config.exception;
...
@ControllerAdvice
@ResponseBody
public class WcycExceptionHandler {
    ...
    public ResponseEntity<ReturnDTO> handleUnauthorizedException(UnauthorizedException e) {
        ...
        return new ResponseEntity(ReturnDTOUtil.unAuthorized(), HttpStatus.UNAUTHORIZED);
    }
     ...
     * @return
     */
    @ExceptionHandler(WcycException.class)
    public ResponseEntity<ReturnDTO> handleBlifeException(WcycException e) {
